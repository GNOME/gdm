...
gchar *s = N_("If the user fails to authenticate himself the login window should Quiver to indicate failure");
...
gchar *s = N_("If you have xinerama multi display setup which screen should the login window appear on.  0 will usually do just fine.");
