...
gchar *s = N_("The script to run when the server sends a WILLING response to a QUERY.  If this is empty or does not exist, the standard message with the system ID is sent.");
