...
static GdmSession *
get_session_for_display (GdmManager *manager,
                         GdmDisplay *display)
{
        if (display == NULL) {
                return NULL;
                                 ...
                                 GDBusMethodInvocation *invocation)
{
        ...
        int               ret;
        GPid              pid;
        uid_t             caller_uid, session_uid, allowed_user;
        ...
        session = get_session_for_display (self, display);
                                                  ...
                                                  const char            *username)
{
        ...
        session = find_session_for_user_on_seat (self, username, seat_id, NULL);
        g_free (seat_id);
        ...
        gdm_session_start_reauthentication (session, pid, caller_uid);
