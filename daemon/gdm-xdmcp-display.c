...
static void
gdm_xdmcp_display_start_server (GdmDisplay *display)
{
        GdmXdmcpDisplay *self = GDM_XDMCP_DISPLAY (display);

        g_timeout_add (500, (GSourceFunc)idle_connect_to_display, self);

        GDM_DISPLAY_CLASS (gdm_xdmcp_display_parent_class)->start_server (display);
}
...
gdm_xdmcp_display_class_init (GdmXdmcpDisplayClass *klass)
{
        ...
        display_class->start_server = gdm_xdmcp_display_start_server;
