...
#define INITIAL_SETUP_HOME (GDM_RUN_DIR "/gnome-initial-setup")
                          ...
                          gboolean              start_session)
{
        ...
        g_hash_table_insert (hash, g_strdup ("HOME"), g_strdup (launch_environment->user_home));
        g_hash_table_insert (hash, g_strdup ("PWD"), g_strdup (launch_environment->user_home));
...
gboolean
gdm_launch_environment_allocate_uid (GdmLaunchEnvironment  *launch_environment,
                                     uid_t                 *uid,
                                     GError               **error)
{
        return gdm_dynamic_user_store_create (launch_environment->dyn_user_store,
                                              launch_environment->preferred_user_name,
                                              launch_environment->user_disp_name,
                                              launch_environment->user_home,
...
static void
_gdm_launch_environment_set_user_home (GdmLaunchEnvironment *launch_environment,
                                       const char           *home)
{
        g_free (launch_environment->user_home);
        launch_environment->user_home = g_strdup (home);
}
...
static void
_gdm_launch_environment_set_dyn_user_store (GdmLaunchEnvironment *launch_environment,
                                            GdmDynamicUserStore  *store)
{
        g_clear_object (&launch_environment->dyn_user_store);
        if (store != NULL)
                launch_environment->dyn_user_store = g_object_ref (store);
}
                                     ...
                                     GParamSpec   *pspec)
{
        ...
        case PROP_USER_DISP_NAME:
                ...
                break;
        case PROP_USER_HOME:
                _gdm_launch_environment_set_user_home (self, g_value_get_string (value));
                break;
        ...
        case PROP_DYN_USER_STORE:
                _gdm_launch_environment_set_dyn_user_store (self, g_value_get_object (value));
                break;
        default:
                                     ...
                                     GParamSpec *pspec)
{
        ...
        case PROP_USER_DISP_NAME:
                ...
                break;
        case PROP_USER_HOME:
                g_value_set_string (value, self->user_home);
                break;
        case PROP_USER_MEMBER_OF:
        ...
        case PROP_COMMAND:
                ...
                break;
        case PROP_DYN_USER_STORE:
                g_value_set_object (value, self->dyn_user_store);
                break;
        default:
                G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
                break;
...
gdm_launch_environment_init (GdmLaunchEnvironment *launch_environment)
{
        ...
        launch_environment->dyn_user_name = NULL;
        launch_environment->dyn_uid = 0;
}
...
create_gnome_session_environment (GdmDynamicUserStore *dyn_user_store,
                                  const char *session_id,
...
gdm_create_greeter_launch_environment (GdmDynamicUserStore *dyn_user_store,
                                       const char          *display_name,
                                       const char          *seat_id,
                                       const char          *session_type,
                                       const char          *display_hostname,
                                       gboolean             display_is_local)
{
        return create_gnome_session_environment (dyn_user_store,
                                                 NULL,
...
GdmLaunchEnvironment *
gdm_create_initial_setup_launch_environment (GdmDynamicUserStore *dyn_user_store,
                                             const char          *display_name,
                                             const char          *seat_id,
                                             const char          *session_type,
                                             const char          *display_hostname,
...
GdmLaunchEnvironment *
gdm_create_chooser_launch_environment (GdmDynamicUserStore *dyn_user_store,
                                       const char          *display_name,
                                       const char          *seat_id,
                                       const char          *display_hostname)
