...
static void
on_display_disposed (gpointer data,
                     GObject *display)
{
        ...
        g_dbus_method_invocation_return_error_literal (invocation,
                                                       G_DBUS_ERROR,
                                                       G_DBUS_ERROR_FAILED,
                                                       "Display destroyed before being exported");
}
                     ...
                     GDBusMethodInvocation *invocation)
{
        ...
        g_object_weak_unref (G_OBJECT (display), on_display_disposed, invocation);
                                   ...
                                   GDBusMethodInvocation *invocation)
{
        ...
        g_signal_connect_object (display, "notify::is-exported",
                                 ...
                                 invocation,
                                 0);
        g_object_weak_ref (G_OBJECT (display), on_display_disposed, invocation);
}
...
static gboolean
handle_create_user_display (GdmDBusRemoteDisplayFactory *skeleton,
                            GDBusMethodInvocation       *invocation,
                            const char                  *user,
                            GdmRemoteDisplayFactory     *factory)
{
...
static gboolean
handle_destroy_user_display (GdmDBusRemoteDisplayFactory *skeleton,
                             GDBusMethodInvocation       *invocation,
                             const char                  *user,
                             GdmRemoteDisplayFactory     *factory)
{
        ...
        gdm_dbus_remote_display_factory_complete_destroy_user_display (skeleton,
                                                                       invocation);
...
static gboolean
on_authorize_method (GdmDBusRemoteDisplayFactory *skeleton,
                     GDBusMethodInvocation       *invocation,
                     GdmRemoteDisplayFactory     *factory)
{
        g_autoptr (GError) error = NULL;
