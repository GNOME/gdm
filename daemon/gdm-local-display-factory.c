...
#define WAIT_TO_FINISH_TIMEOUT 5 /* seconds */
                                  ...
                                  GdmDisplay             *display)
{
        ...
        /* If this was a manual VT switch to an existing session we will not get
         * a status change, schedule a timeout to finish things in this case. */
